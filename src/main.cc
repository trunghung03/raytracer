...
hittable_list random_scene() {
    ...
    const static auto ground_material = make_shared<lambertian>(color(0.5, 0.5, 0.5));
    ...
    const auto material3 = make_shared<light>(color(0.7, 0.6, 0.5), 10);
...
/*hittable_list random_scene() {
	...
	world.add(make_shared<triangle>(
		point3(0, 2, 0), point3(-4, 0, 0), point3(4, 0, 0),
		material2
	));
